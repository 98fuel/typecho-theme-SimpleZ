        ...
        <div class="post">
            ...
            <details class="copy-text" open>
                ...
                <ul>
                    ...
                    <li>最后更新时间为&nbsp;&nbsp;<span style="color:#000;text-decoration:underline;"><?php echo date('Y-m-d H:i:s' , $this->modified); ?></span>&nbsp;&nbsp;(<span class="lately-c"><?php echo date('Y-m-d H:i:s' , $this->modified); ?></span>)，如果资源无效请在评论区留言。</li>
